...
public class Fakture {
    ...
    public int getOdobrio_admin_id() { return odobrio_admin_id; }
    public void setOdobrio_admin_id(int odobrio_admin_id) { this.odobrio_admin_id = odobrio_admin_id; }
